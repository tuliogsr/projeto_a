...
${BUILD}/main.o: ${INCLUDE}/usuario/cadastro_usuario.hpp ${INCLUDE}/usuario/carregar_usuario.hpp ${INCLUDE}/mercado/analise_oportuna.hpp ${INCLUDE}/usuario/alertas_preco.hpp ${INCLUDE}/mercado/classes_ativos.hpp ${INCLUDE}/usuario/Grafics.hpp ${INCLUDE}/mercado/Catalogo.hpp ${SRC}/main.cpp
